...
import eu.socialdancing.sdscan.droid.connectivity.ConnectivityHelper
import eu.socialdancing.sdscan.utils.KeystoreHelper
...
class sdscan : MultiDexApplication() {
