...
import eu.socialdancing.sdscan.droid.EventSelection
import eu.socialdancing.sdscan.droid.sdscan
import eu.socialdancing.sdscan.droid.R
import eu.socialdancing.sdscan.droid.databinding.ActivityEventConfigBinding
import eu.socialdancing.sdscan.droid.databinding.ItemEventSelectionBinding
...
class EventConfigActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        conf = AppConfig(this)
        eventSelectionAdapter = EventSelectionAdapter((application as sdscan).data, conf, this)
