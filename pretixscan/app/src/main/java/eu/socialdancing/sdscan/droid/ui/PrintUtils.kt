...
import eu.socialdancing.sdscan.droid.BuildConfig
...
fun getBadgeLayout(application: sdscan, position: JSONObject, eventSlug: String): BadgeLayout? {
...
fun printBadge(context: Context, application: sdscan, position: JSONObject, eventSlug: String, recv: ResultReceiver?) {
