...
import eu.socialdancing.sdscan.droid.AndroidHttpClientFactory
...
import eu.socialdancing.sdscan.droid.databinding.ActivityEventSelectBinding
import eu.socialdancing.sdscan.droid.databinding.EventSelectCalendarDayBinding
import eu.socialdancing.sdscan.droid.databinding.EventSelectCalendarHeaderBinding
import eu.socialdancing.sdscan.utils.daysOfWeekFromLocale
...
class EventSelectActivity : MorphingDialogActivity() {
    ...
    fun refreshEvents() {
        ...
        eventManager = EventManager((application as sdscan).data, api, conf, false)
